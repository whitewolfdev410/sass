...
const SignIn = () => {
  ...
  return (
    <Stack
      ...
      flexWrap="wrap"
      gap={5}
      m="187px 111px auto 201px"
      className="content-wrapper"
      justifyContent="space-between"
    >
      <Box className="auth-candidate" sx={{ mt: "11px" }}>
        <Typography variant="h1" component="h1" sx={{ mb: 3 }}>
          Sign in to your account
        </Typography>
        <Typography fontSize={14} sx={{ mb: 3 }}>
          It looks like you have an account to track the program update, please
          sign in to check the status of your application
        </Typography>
