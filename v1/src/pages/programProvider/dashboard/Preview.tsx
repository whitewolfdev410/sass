...
const Preview = () => {
	...
	return (
		...
		// <CreateProgramLayout>
		//   <Stack
		//     sx={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 3, my: 2 }}
		...
		//         in London. Apart from gaining international working experience, you
		//         will learn the British working culture, gain international work
		...
		//         cutting-edge technology. Whether you're looking to build your career
		//         or learn crucial skills to take away, our list of London firms have
		//         plenty to offer, and with so much under the belt for what this city
		//         has to offer, there's certainly no room for boredom.
		//         <ul style={{ marginTop: "16px" }}>
		//           <li>
		//             On-Job Training: The program is designed to enrich the
		//             participant's knowledge and provide them with the skills needed
		//             in this early stage of their career to be ready for their
		//             professional lives.
		//           </li>
		...
		//               passing the iTEP Internship test at the B2 level or must have
		//               a valid IELTS test score of 6.0 or above. Or a TOEFL test
		//               score of 80 or above.
		//             </li>
		//             <li>
		//               You will be exempted from the language test requirement if you
		//               have completed your studies in UK, Canada, USA, New Zeland or
		//               Australia.
		//             </li>
		//             <li>
